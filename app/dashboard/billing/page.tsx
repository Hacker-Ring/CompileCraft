...
function billing() {
  ...
  return (
    <div className='bg-slate-900 min-h-screen'>
      ...
      <h2 className='text-center font-bold text-3xl my-3 text-gray-200'>Upgrade With Monthly Plan</h2>
 
  <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:items-center md:gap-8">
 
    <div className="rounded-2xl bg-slate-800 border border-slate-600 p-6 shadow-sm sm:px-8 lg:p-12">
      <div className="text-center">
        ...
        <p className="mt-2 sm:mt-4">
          <strong className="text-3xl font-bold text-gray-200 sm:text-4xl"> 0$ </strong>
    ...
    <div className="rounded-2xl bg-slate-800 border border-slate-600 p-6 shadow-sm sm:px-8 lg:p-12">
      <div className="text-center">
        ...
        <p className="mt-2 sm:mt-4">
          <strong className="text-3xl font-bold text-gray-200 sm:text-4xl"> 9.99$ </strong>
      ...
      disabled={loading}
        ...
        className='w-full rounded-full mt-5 p-6 bg-blue-600 hover:bg-blue-700 text-white'
        variant='default'
      >
